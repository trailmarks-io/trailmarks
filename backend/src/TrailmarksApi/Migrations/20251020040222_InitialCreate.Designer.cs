...
namespace TrailmarksApi.Migrations.Migrations
{
    ...
    [Migration("20251020040222_InitialCreate")]
    partial class InitialCreate
    {
        /// <summary>
        /// Configures the Entity Framework Core model that represents the target database schema for this migration.
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to define entities, owned types, annotations, indexes, and table mappings for the migration.</param>
