...
namespace TrailmarksApi.Migrations.Migrations
{
    ...
    {
        /// <summary>
        /// Builds the EF Core model snapshot for ApplicationDbContext by registering the Translation and Wanderstein entities, their properties, keys, indexes, table/column mappings, and the owned GeoCoordinate mapping, including Npgsql identity configuration.
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to construct the EF Core model metadata.</param>
